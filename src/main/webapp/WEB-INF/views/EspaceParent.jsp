...
<tr><td><input type="submit" value="Chercher Par Adresse"></td></tr>
   ...
   <c:forEach items="${babysitters}" var="p">
                    <div class="col-xs-6 col-sm-4 col-md-3 portfolio-item branded logos">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-single">
                                <div class="portfolio-thumb">
                                <img src="/pu/EspaceParent/photo?idJ=${p.idUser}" class="img-responsive" alt="">
                                 <ul class="nav nav-pills">
                                        <li><a href="/pu/EspaceParent/Details?id=${p.idUser}"><i class="fa fa-link"></i></a></li>
                                        <li><a href="/pu/EspaceParent/photo?idJ=${p.idUser}" data-lightbox="example-set"><i class="fa fa-eye"></i></a></li>
                                    </ul>
                            	 </div>
