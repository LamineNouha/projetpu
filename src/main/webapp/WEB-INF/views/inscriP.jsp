            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="contact-form bottom">
                        <h2>Signing up as a parent</h2>
                      
                    
               
    <f:form modelAttribute="parent" action="/inscrit_parent" method="post">
<!-- multiapart.. : pour l upload de la photo -->
            
            <div class="slide-text">
                 <div class="form-group">
             
            Login : <f:input path="userName" class="form-control"  type="text" size="12"/>
 <p> <f:errors path="userName"></f:errors></p>
        ...
        <div class="form-group">
         ...
         Password :<f:input path="password" class="form-control" type="password" size="12" />
 <p> <f:errors path="password"></f:errors></p>
             ...
             <div class="form-group">
          Email adress:
 <f:input path="email" class="form-control" size="12"/>
 <p> <f:errors path="email"></f:errors></p>
    ...
    <a href="/pu/EspaceParent">login</a>
         </div> </div>
