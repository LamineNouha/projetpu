...
<body>
        ...
        <div class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/pu/EspaceBabysitter">
        ...
        <div class="vertical-center sun">
             <div class="container">
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            <h1 class="title">Bienvenu ${current.userName}</h1>
                            <h2>Vos Informations :</h2>
                            <p>Nom : ${current.nom}<p>
                            <p>Prenom: ${current.prenom}<p>
                            <p>Adresse :${current.adresse}<p>
                            <p>Email : ${current.email}<p>
                            <p>Age : ${current.age}<p>
                            <p>Sexe : ${current.sexe}<p>
                            <p>Salaire : ${current.salaire}<p>    
                        </div>
                    </div>
                </div>
            </div>
  ...
  <f:form action="/EspaceBabysitter/edit?id=${current.idUser}" method="post">
...
<f:form action="/EspaceBabysitter/delete?id=${current.idUser}" method="post">
